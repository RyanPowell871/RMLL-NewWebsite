/**
 * Component schema definitions for the server-side API.
 *
 * These schemas mirror the client-side schemas but are included inline
 * so the Supabase edge function can access them.
 */
...
export interface InlineTextField {
  type: 'inline';
  label: string;
  pattern: string; // String representation of regex
