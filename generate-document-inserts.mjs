...
// Run with: node generate-document-inserts.mjs

import { createClient } from '@supabase/supabase-js';
import fs from 'fs';

// Get these from your Supabase Dashboard → Settings → API
const SUPABASE_URL = 'https://qkvpzxvbgpwwqzcvnxtm.supabase.co';
const SUPABASE_SERVICE_ROLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFrdnB6eHZiZ3B3dXpxY3ZueHRtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMzU5MDIxOSwiZXhwIjoyMDQ5MTY2MjE5fQ.9fU8kRm6q0X3YqM7Fp9b3n2K5e5g6H3yL4j1k2M9l8N0';
...
`;
  ...
  // Write to file
  fs.writeFileSync('./document-migration-inserts.sql', sqlOutput);
